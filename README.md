# DSB-LC-modulation-demodulation
<ul dir="auto">
...
clone the repo and run  the code on matlab so you will see the figures and you will hear the signal after the demodulation and it is almost the same as the orignal signal which if perfet 
